...
#include "../../qt-calendar/calendarwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CalendarWidget_t, stringdata) + ofs \
...
const QMetaObject CalendarWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CalendarWidget.data,
      qt_meta_data_CalendarWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalendarWidget.stringdata))
